                    ...
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
                        <div className="flex flex-col items-center gap-5 opacity-40 animate-in fade-in zoom-in-95 duration-1000 slide-in-from-bottom-4">
                            ...
                            <div className="flex flex-col items-center gap-1.5">
                                <span className="text-gray-300 font-semibold tracking-wide text-2xl font-['Satoshi'] drop-shadow-md">Start building your AI workflow</span>
                                <span className="text-gray-500 text-[16px] font-medium tracking-wide">Drag nodes into the canvas to create intelligent automation pipelines.</span>
                            </div>
                        </div>
                    </div>
                )}
